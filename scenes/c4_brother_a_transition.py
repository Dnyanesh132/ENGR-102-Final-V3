...
class brother_a_transition(Scene):
    def __init__(self):
        ##### shows transition for about 3 seconds then goes to classroom
        super().__init__(3.0, "classroom")
